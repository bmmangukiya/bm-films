  ...
  return (
    ...
    >
      ...
      <p className="font-medium text-white w-[80dvw] md:w-[75dvw] lg:w-[50dvw]">
        ...
        creators and story hackers we enable you to do more with your brand, assets and audience than you thought was possible. We are what
        we make and we love what we do.
      </p>
    </section>
  );
};
