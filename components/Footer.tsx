...
const Footer = () => {
  return (
    <footer className="flex w-full flex-col gap-2 flex-wrap bg-black text-white items-center justify-center border-t border-slate-700/10 py-6 text-center md:justify-between px-5">
      <span>Follow us</span>
      ...
      <div>
        ...
        <div color="blue-gray" className="text-xs inline-flex items-center w-full gap-1">
          ...
          <svg className="h-3 w-3 fill-rose-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
